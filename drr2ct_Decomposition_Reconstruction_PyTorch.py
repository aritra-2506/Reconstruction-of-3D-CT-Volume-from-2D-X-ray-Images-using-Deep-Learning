...
with torch.set_grad_enabled(False):
    for i, (image_app, label_app) in enumerate(
        ...
        ds = write_dicom(t, 0, slicesLocation, dss)
        ds.save_as(r"/content/drive/My Drive/NewDataset/new_saved_img/1.dcm")


dss=pydicom.read_file("/content/drive/My Drive/NewDataset/new_saved_img/1.dcm")
w=dss.pixel_array
dss1=pydicom.read_file("/content/drive/My Drive/NewDataset/new_saved_slices/%d.dcm" % (slice_number,))
v=dss1.pixel_array
