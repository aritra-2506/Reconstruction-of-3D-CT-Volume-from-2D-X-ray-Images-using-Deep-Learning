...
optimizer = optim.Adam(output.parameters(), lr=0.000001, momentum=0.9)
...
for i in range(0, h):
    ...
    plt.imshow(images_test1[i].reshape((256,256)), cmap=plt.cm.bone)
    plt.subplot(2, 3, 2)
    plt.title('DRR Ribs')
    plt.imshow(outputs_np1[i].reshape((256,256)), cmap=plt.cm.bone)
    plt.subplot(2, 3, 3)
    plt.title('DRR Vascular')
    plt.imshow(outputs_np2[i].reshape((256,256)), cmap=plt.cm.bone)
    plt.subplot(2, 3, 4)
    plt.title('DRR Spine')
    plt.imshow(outputs_np3[i].reshape((256,256)), cmap=plt.cm.bone)
    plt.subplot(2, 3, 5)
    plt.title('DRR Reconstructed')
    plt.imshow(outputs_np[i].reshape((256,256)), cmap=plt.cm.bone)
    plt.show()
